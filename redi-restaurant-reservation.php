		...
		function redi_restaurant_ajax() {
			...
			switch ( $_POST['get'] ) {
				case 'step1':
					...
					// $startTimeStr = $date['year'].'-'.$date['month'].'-'.$date['day'].' 07:00';
					...
					/*if ( $dayname != "Sunday" ) {
						if ( $_POST['session'] == "breakfast" ) {
							...
							$alternatives = 12;
						} elseif ( $_POST['session'] == "lunch" ) {
							// echo  $startTimeStr;
							$endTimeStr   = $date['year'] . '-' . $date['month'] . '-' . $date['day'] . ' ' . '14:0';
							$alternatives = 8;
						} else {
							$endTimeStr   = $date['year'] . '-' . $date['month'] . '-' . $date['day'] . ' ' . '19:00';
							$alternatives = 12;
						}
					} else {
					...
					//echo  self::getAlternativeTimeStep($persons);
					$params = array(
